...
cors_origins = os.getenv(
    "CORS_ORIGINS",
    "http://localhost:5173,http://localhost:5174,http://127.0.0.1:5174,https://inventory-management-system-iris408.vercel.app,https://partspilot.uk,https://www.partspilot.uk",
)
